...
class CourseCategory(models.Model):
    ...
    id   name
     ...
     2    前段
    """
    name = models.CharField('课程大类',max_length=64, unique=True)
...
class CourseSubCategory(models.Model):
    ...
    name = models.CharField('课程子类',max_length=64, unique=True)
...
class DegreeCourse(models.Model):
    ...
    course_img = models.CharField(max_length=255, verbose_name="缩略图",null=True,blank=True)
    brief = models.TextField(verbose_name="学位课程简介", null=True,blank=True)
...
class Scholarship(models.Model):
    """学位课程奖学金"""
    degree_course = models.ForeignKey("DegreeCourse",verbose_name='学位课程')
...
class Course(models.Model):
    """课程"""
    name = models.CharField('课程名称',max_length=128, unique=True)
    course_img = models.CharField(max_length=255,null=True,blank=True)
    sub_category = models.ForeignKey("CourseSubCategory",verbose_name='课程类别')
...
class CourseDetail(models.Model):
    """课程详情页内容"""
    course = models.OneToOneField("Course",verbose_name='课程')
...
class CourseOutline(models.Model):
    """课程大纲"""
    course_detail = models.ForeignKey("CourseDetail",verbose_name='课程')
...
class CourseChapter(models.Model):
    """课程章节"""
    course = models.ForeignKey("Course", related_name='coursechapters',verbose_name='所属课程')
...
class CourseSection(models.Model):
    """课时目录"""
    chapter = models.ForeignKey("CourseChapter", related_name='coursesections',verbose_name='所属章节')
    name = models.CharField(max_length=128)
